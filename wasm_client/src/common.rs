...
// Handle Message (Analogous to the handle message on the Signaling Server)
...
// Get Video by calling the Navigator API and constraints, to get a media stream
...
// What to do on clicking Start Session?

// 1. When ICE Connection State Changes, Start Remote Video
// 2. Add Local Video Stream
// 3. What to do on DataChannel
// 4. Setup RTCPeerConnection
// 5. New session
...
// 2. Pong
// 3. Start Remote Video

// What to do on clicking Connect to Session?
...
// When we are connected via RTCPeerConnection, get remote streams, creating an HtmpVideoElement, and passing the media stream
...
// Send message with SessionJoin signal
