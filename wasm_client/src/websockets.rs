...
// IP and PORT of the Signaling Server

const WS_IP_PORT: &str = "ws://192.168.1.35:2794";
...
pub async fn open_web_socket(
    ...
    // New WebSocket to the IP and PORT hardcoded

    let ws = WebSocket::new(WS_IP_PORT)?;

    // How we transport the data
    // This is a connection to the Signaling Server
